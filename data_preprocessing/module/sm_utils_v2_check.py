...
def load_data(source, purpose, pathology, dir_default='/mnt/disk1/project/public/SMhospital/Database/1_ongoing/', model=''):
    ...
    dir_detail = dir_default + source + model + '/' + purpose + '/'
